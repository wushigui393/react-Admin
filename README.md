<div align="center">
<a href="https://gitee.com/wu_shigui/react-admin">
...
- [gitee site](http://wu_shigui.gitee.io/react-xs-admin/)

<img src="https://www.wu_shigui.com/image/react-xs-admin1.png?max=xiaosi" width="100%">

<img src="https://www.wu_shigui.com/image/react-xs-admin2.png?max=xiaosi" width="100%">
...
```bash
git clone https://gitee.com/wu_shigui/react-admin.git

git clone git@github.com:wu_shigui/react-xs-admin.git
```

Alternatively, you can use the [`xs-cli`](https://github.com/wu_shigui/xs-cli)to quickly create one

```bash
npx @wu_shigui/xs-cli create [project-name]
```
...
- [react-xs-admin](https://gitee.com/wu_shigui/react-admin)
...
[@wu_shigui](https://github.com/wu_shigui)
